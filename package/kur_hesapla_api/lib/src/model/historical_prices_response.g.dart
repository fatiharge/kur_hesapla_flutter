...
class _$HistoricalPricesResponse extends HistoricalPricesResponse {
  ...
  @override
  final BuiltMap<String, String>? errorDates;
  ...
  _$HistoricalPricesResponse._({this.meta, this.data, this.errorDates})
      : super._();
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, errorDates.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
...
class HistoricalPricesResponseBuilder
  ...
  MapBuilder<String, String>? _errorDates;
  MapBuilder<String, String> get errorDates =>
      _$this._errorDates ??= new MapBuilder<String, String>();
  set errorDates(MapBuilder<String, String>? errorDates) =>
      _$this._errorDates = errorDates;
  ...
  HistoricalPricesResponseBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _errorDates = $v.errorDates?.toBuilder();
      _$v = null;
    }
    return this;
  }
